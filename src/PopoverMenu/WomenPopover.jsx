...
export function WomMen() {
    return (
        <Popover 
            trigger="hover" 
            content={
                <section className="flex flex-col lg:flex-row rounded-xl shadow-lg bg-white  overflow-auto">
                            ...
                            <div className="relative rounded-xl overflow-hidden">
                                <div className="w-fit overflow-hidden rounded-xl">
                                    <img 
                                        ...
                                        alt="Summer Sale" 
                                        className="w-full h-full object-cover rounded-xl transition duration-300 ease-in-out hover:scale-110"
                                    />
                                </div>  
