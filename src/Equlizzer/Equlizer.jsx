...
export function Equlizzer() {
  return (
    <Dropdown label="" className="rounded-xl  "dismissOnClick={false} size="2xl" renderTrigger={() =><img src="three-equalizer-bars-svgrepo-com.svg" alt="" className="w-5 rotate-90"/>}>
